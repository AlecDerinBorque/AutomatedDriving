...
ASSETS_DIR = os.path.join(os.path.dirname('/Users/alec/pythonProjects/assets/car (1).png'), "..", "assets")
...
_car_img_cache: Optional[pygame.Surface] = None

def _load_car_image() -> pygame.Surface:
    global _car_img_cache
    if _car_img_cache is None:
        # Note the (1) in the filename to match your assets folder
        path = "/Users/alec/pythonProjects/assets/car (1).png"
        
        if not os.path.exists(path):
            raise FileNotFoundError(f"Double-check your filename! Tried to find: {path}")
